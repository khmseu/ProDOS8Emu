...
namespace prodos8emu {
  ...
  namespace {
    ...
    static const MonitorSymbol kMonitorSymbols[] = {
        ...
        {0x7800, "Assembler", MonitorSymbolPc},
        {0x7800, "ColdStrt", MonitorSymbolPc},
        {0x7816, "ExecAsm", MonitorSymbolPc},
        ...
        {0x7F0F, "DoPass2", MonitorSymbolPc},
        ...
        {0xB6E6, "DoAsmbly", MonitorSymbolPc},
        ...
        {0xB844, "LoadMod", MonitorSymbolPc},
